...
try {
    ...
    if ($probeExitCode -ne 0 -or
        $output -notmatch '^BEACON_QUIC_LOOPBACK_OK 5 CERT_PIN_OK ALPN_VERSION_OK REPLAY_RECONNECT_OK MEDIA_RECOVERY_EVENTS_OK ORDERED_SESSION_ACTIONS_OK CALLBACK_FAULTS_OK DISCONNECT_FAULTS_OK$') {
