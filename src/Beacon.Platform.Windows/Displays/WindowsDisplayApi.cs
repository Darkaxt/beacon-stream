    ...
    IAsyncDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Task.FromResult(DisplayApiResult.Fail(beforeTopologyDiagnostic));
        }
    ...
    {
        DisplayApiResult activeResult = EnsureDisplayConfigTargetActive(
            addOutput,
            displayName,
            preservedActivePaths);
