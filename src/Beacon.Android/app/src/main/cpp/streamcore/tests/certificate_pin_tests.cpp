...
void validates_exact_der_spki_sha256_pin() {
  ...
  require(der_size > 0 && der_buffer != nullptr);
  ...
  require(spki_size > 0 && spki_buffer != nullptr);
  ...
  require(SHA256(spki_buffer, static_cast<std::size_t>(spki_size),
  ...
  require(beacon::android::streamcore::validate_der_spki_pin(der, expected));
