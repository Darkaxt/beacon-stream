...
| quictls/openssl (`ff36838`, the MsQuic `v2.5.9` gitlink) | Future Android MsQuic build only | Apache-2.0 | Build the exact non-Windows TLS source required by pinned MsQuic; do not initialize or float the upstream Git submodule. |
