...
It can also simulate named telemetry profiles through the no-phone script: hello, profile fetch, allowed profile patch, capabilities, telemetry, plan, launch, disconnect, reconnect, plan refresh, quit, and emergency restore.
